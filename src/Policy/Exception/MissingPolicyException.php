    ...
    public function __construct($resource, ?int $code = null, ?Throwable $previous = null)
    {
        if (is_object($resource)) {
            ...
            if (
                ...
                $queryMessage = ' This resource looks like a Query, if you are using the OrmResolver, you might need to create a new policy class for your %s class in `src/Policy/`';
